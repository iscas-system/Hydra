...
//func (m *BranchAndBoundTemplate) MinCostT2(params *MinCostParams) (float64, []types.Job) {
...
func (m *BranchAndBoundTemplate) MinCost(params *MinCostParams) (float64, []types.Job) {
	...
	if len(params.Jobs) == 2 &&
		params.Jobs[0].JobName() == "64ac96d3ed8a3f012387b073" &&
		params.Jobs[1].JobName() == "2c3e7f313340e4bd732ddd5c" {
		fmt.Printf("pong.")
	}
	//if len(params.Jobs) == 15 {
	//	fmt.Printf("jobs count 15")
	//}
	start := time.Now()
	defer func() {
